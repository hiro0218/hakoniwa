...
(function() {
  ...
  cpick = function(trigger, target, p) {
    ...
    //
    if (!/^input$/i.test(target.nodeName) || !/^text$/.test(target.type)) {
      return;
    }
    if (!/^(input|button)$/i.test(trigger.nodeName)) {
      return;
    }
    /* -------------------------------------------------------------------
     * default settings
  ...
  proto._create_panel = function() {
    ...
    // set event listeners
    var _this = this;
    _add_event_listener(palette, "mousedown", function(e) {
      _this._pallet_clicked(e);
    });
    _add_event_listener(bar, "mousedown", function(e) {
      _this._lightness_bar_clicked(e);
    });
    _add_event_listener(okb, "click", function(e) {
      _this._ok_clicked(e);
    });
    _add_event_listener(ccb, "click", function(e) {
      _this._cencel_clicked(e);
    });
    ...
    _add_event_listener(document, "mousedown", function(e) {
      _this.hide();
    });
    _add_event_listener(this.nodes.target, "mousedown", function(e) {
      stop_propagation(e);
    });
    _add_event_listener(this.nodes.trigger, "mousedown", function(e) {
      stop_propagation(e);
    });
    _add_event_listener(panel, "mousedown", function(e) {
      stop_propagation(e);
    });
    _add_event_listener(okb, "mousedown", function(e) {
      stop_propagation(e);
    });
    _add_event_listener(ccb, "mousedown", function(e) {
      stop_propagation(e);
    });
    //
    return panel;
  ...
  proto._palette_drag_event_prepare = function() {
    ...
    var mouse_move = function(o, e) {
      if (o.nodes.palette._dragging != true) {
        return;
      }
      prevent_default(e);
      stop_propagation(e);
    ...
    _add_event_listener(palette, "mouseup", function(e) {
      mouse_up(_this, e);
    });
    _add_event_listener(palette, "mousemove", function(e) {
      mouse_move(_this, e);
    });
    _add_event_listener(panel, "mousemove", function(e) {
      mouse_move_panel(_this, e);
    });
  };
  ...
  proto._lightness_bar_drag_event_prepare = function() {
    ...
    _add_event_listener(bar, "mouseup", function(e) {
      mouse_up(_this, e);
    });
    _add_event_listener(bar, "mousemove", function(e) {
      mouse_move(_this, e);
    });
    _add_event_listener(panel, "mousemove", function(e) {
      mouse_move_panel(_this, e);
